...
namespace Infrastructure.Services
{
    public class OrderService : IOrderService, IScopedDependency
    {
        ...
        public async Task<List<ShowOrderDto>> SelectAllOrders(CancellationToken cancellationToken)
        {
            var orders = await _orderRepository.TableNoTracking.ProjectTo<ShowOrderDto>(_mapper.ConfigurationProvider)
